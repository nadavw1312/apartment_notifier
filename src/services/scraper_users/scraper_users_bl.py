...
class ScraperUserBL:
    ...
    @classmethod
    async def _create_scraper_user(
        cls,
        db: AsyncSession,
        email: str,
        source: str,
    ...
    @classmethod
    async def _update_scraper_user(
        cls,
        db: AsyncSession,
        user_id: int,
        **kwargs
    ...
    @classmethod
    async def _set_scraper_user_active(
        cls,
        db: AsyncSession,
        user_id: int,
        is_active: bool
    ...
    @classmethod
    async def _save_user_session_data(
        cls,
        db: AsyncSession,
        user_id: int,
    ...
    @classmethod
    async def _get_active_scraper_users_by_source(
        cls,
        db: AsyncSession,
        source: str
    ) -> List[ScraperUser]:
    ...
    async def create_facebook_user(
        ...
        return await cls._create_scraper_user(
            db,
            email=email,
            source='facebook',
            password=password,
    ...
    async def save_facebook_session_data(
        ...
        if not user:
            return None
        return await cls._save_user_session_data(db, user.id, session_data)
    ...
    async def get_active_facebook_users(
        ...
        return await cls._get_active_scraper_users_by_source(db, 'facebook')
